...
char calculerDirectionVersPomme(int xTete, int yTete, int xPomme, int yPomme);
...
int main(){
	...
	do {
		...
		direction = calculerDirectionVersPomme(lesX[0], lesY[0], lesPommesX[nbPommes], lesPommesY[nbPommes]);
